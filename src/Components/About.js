    ...
    <div className='overflow-hidden min-h-screen bg-gradient-to-b from-black via-blue-800 to-blue-500'>
      ...
      <div className='flex flex-col md:flex-row md:py-14 md:px-44'>
          <div className='md:w-1/2'>
            ...
            <img src={Image3} alt='Image3' className=' w-1/2 h-1/2 md:w-full md:h-full md:border-2 md:border-black md:rounded-xl ml-20 rounded-lg' style={{ boxShadow: "0 0 20px white" }} />
              </div>
            ...
            <img src={Image3} alt='Image3' className='hidden md:block w-1/2 h-1/2 md:w-full md:h-full md:border-2 md:border-black md:rounded-xl ml-20 rounded-lg md:ml-2' style={{ boxShadow: "0 0 20px white" }} />
